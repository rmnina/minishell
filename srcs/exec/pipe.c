...
/*   Updated: 2024/01/15 17:59:54 by jdufour          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/minishell.h"

// void	init_pipe(t_minishell **main, int *i, t_alloc **garbage)
// {
	
// }

// void	middle_pipe(t_minishell **main, int *i, t_alloc **garbage)
// {
	
// }

// void	last_pipe(t_minishell **main, int *i, t_alloc **garbage)
