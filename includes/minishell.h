...
/*   Updated: 2024/01/24 19:54:57 by juandrie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		init_get_expand(t_minishell **main, \
t_command *token, int *i, t_alloc **garbage);
...
bool		identifiers(const char *str, char *ptr, \
bool *equals, bool *no_space);
...
int			replace_var(t_minishell **main, char **new_line, \
...
t_alloc **garbage);
int			browse_outputs(t_minishell **main, int *i, \
...
int cat, t_alloc **garbage);
char		**ft_envjoin(char **envp, char *str, int cat, t_alloc **garbage);
char		**ft_strjoin_args(t_minishell **main, int *i, \
int cat, t_alloc **garbage);
